/**
 * shadcn/ui — Calendar
 * Built on react-day-picker v8, styled with Tailwind.
 */
"use client";
    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 opacity-70 hover:opacity-100 border-border"
        ),
        ...
        day_today:       "bg-muted text-foreground font-semibold rounded-md",
